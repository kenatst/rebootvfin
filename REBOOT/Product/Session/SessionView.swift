                ...
                ZStack {
                    ...
                    VStack(spacing: 0) {
                        ...
                        Text(elapsedText(elapsed))
                            .font(Font(AppTypography.plusJakarta(size: quiet ? 42 : 62, weight: 300)))
                            .foregroundStyle(quiet ? AppColors.inkFaint : AppColors.ink)
                            .monospacedDigit()
                            .contentTransition(.numericText())
                            .padding(.top, detail == nil ? 20 : 12)
                        Text("Target: \(record.targetMinutes) min", style: .footnote)
                            .foregroundStyle(AppColors.inkFaint)
                            .padding(.top, 8)
